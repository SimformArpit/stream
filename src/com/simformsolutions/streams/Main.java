package com.simformsolutions.streams;

import com.simformsolutions.streams.employee.Employee;
...
public class Main {
    public static void main(String[] args) {
        ...
        List<Employee> newData = empList.stream().sorted().filter(element -> element.getEmpId() % 2 == 0).toList();
        ...
        List<Employee> nameStartingWithDChar = empList.stream().sorted().filter(element -> element.getEmpName().contains("D")).toList();
